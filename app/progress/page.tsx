  ...
  return (
    <div className="container py-4 md:py-8 px-2 md:px-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-8 gap-3 md:gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold mb-0 md:mb-1">Transaction Progress</h1>
          <p className="text-sm md:text-base text-muted-foreground">Track and manage your real estate transactions</p>
        </div>
        <Button size="sm" className="w-full md:w-auto text-sm">
          <Plus className="mr-1 md:mr-2 h-3 w-3 md:h-4 md:w-4" /> New Transaction
        </Button>
      </div>
        ...
        <div className="w-full md:w-3/4 order-2 md:order-1">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 md:mb-6 gap-3 md:gap-4">
            <div className="relative w-full sm:w-auto">
              ...
              <Input
                ...
                className="pl-8 md:pl-10 w-full sm:w-[250px] md:w-[300px] h-9 text-sm"
              />
            </div>
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Button variant="outline" size="sm" className="flex items-center gap-1 text-xs md:text-sm h-9">
                <Filter className="h-3 w-3 md:h-4 md:w-4" />
                Filter
              </Button>
              <select className="border rounded-md px-2 md:px-3 py-1 text-xs md:text-sm bg-white h-9">
          ...
          <Tabs defaultValue="active">
            ...
            <TabsContent value="all" className="space-y-3 md:space-y-4">
              <p className="text-muted-foreground text-sm">Showing all 6 transactions</p>
              {/* Would include all transactions here */}
            </TabsContent>
          </Tabs>
        </div>

        <div className="w-full md:w-1/4 space-y-4 md:space-y-6 order-1 md:order-2">
          <Card>
            <CardHeader className="pb-2 md:pb-3">
              <CardTitle className="text-base md:text-lg">Title Companies</CardTitle>
              <CardDescription className="text-xs md:text-sm">Your connected title partners</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-2 md:gap-3">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0">
                    <Building className="h-4 w-4 md:h-5 md:w-5 text-slate-600" />
                  </div>
                  <div>
                    <p className="font-medium text-sm md:text-base">Desert Title Company</p>
                    <p className="text-xs md:text-sm text-muted-foreground">3 active transactions</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 md:gap-3">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-sm md:text-base">First American Title</p>
                    <p className="text-xs md:text-sm text-muted-foreground">1 active transaction</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 md:gap-3">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-sm md:text-base">Fidelity National Title</p>
                    <p className="text-xs md:text-sm text-muted-foreground">2 completed transactions</p>
                  </div>
                </div>
                <Button variant="outline" className="w-full text-xs md:text-sm">
                  <Plus className="mr-1 md:mr-2 h-3 w-3 md:h-4 md:w-4" /> Add Title Company
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-2 md:pb-3">
              ...
              <CardDescription className="text-xs md:text-sm">Latest transaction documents</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm md:text-base truncate">Purchase_Agreement_123Main.pdf</p>
                    <p className="text-xs md:text-sm text-muted-foreground">Uploaded 2 hours ago</p>
                  </div>
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm md:text-base truncate">Inspection_Report_456Oak.pdf</p>
                    <p className="text-xs md:text-sm text-muted-foreground">Uploaded 1 day ago</p>
                  </div>
                  <Button variant="ghost" size="icon" className="h-7 w-7 md:h-8 md:w-8">
                    <ArrowUpRight className="h-3 w-3 md:h-4 md:w-4" />
                  </Button>
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm md:text-base truncate">Disclosure_Form_789Pine.pdf</p>
                    <p className="text-xs md:text-sm text-muted-foreground">Uploaded 3 days ago</p>
                  </div>
                  <Button variant="ghost" size="icon" className="h-7 w-7 md:h-8 md:w-8">
                    <ArrowUpRight className="h-3 w-3 md:h-4 md:w-4" />
                  </Button>
          ...
          <Card>
            <CardHeader className="pb-2 md:pb-3">
              ...
              <CardDescription className="text-xs md:text-sm">Important dates to remember</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm md:text-base">Closing: 101 River Lane</p>
                    <p className="text-xs md:text-sm text-muted-foreground">Jul 5, 2023 (3 days left)</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm md:text-base">Inspection: 123 Main Street</p>
                    <p className="text-xs md:text-sm text-muted-foreground">Jul 8, 2023 (6 days left)</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm md:text-base">Financing: 456 Oak Avenue</p>
                    <p className="text-xs md:text-sm text-muted-foreground">Jul 20, 2023 (18 days left)</p>
                  </div>
                </div>
                <Button variant="outline" className="w-full text-xs md:text-sm">
                  View Calendar
      ...
      <div className="flex flex-col md:flex-row">
        <div className="p-4 md:p-6 flex-1">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 md:mb-4 gap-2">
            <h3 className="font-semibold text-sm md:text-lg truncate">{address}</h3>
            <div className="flex items-center gap-2">
              <Badge className={`${statusColor} text-white text-xs`}>{status}</Badge>
              <span className="font-bold text-sm md:text-base">{price}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 mb-3 md:mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs md:text-sm truncate">Due: {dueDate}</span>
            </div>
            <div className="flex items-center gap-2">
              <Building className="h-3 w-3 md:h-4 md:w-4 text-muted-foreground flex-shrink-0" />
              <span className="text-xs md:text-sm truncate">{titleCompany}</span>
            </div>
          </div>

          <div className="flex items-center gap-2 mb-3 md:mb-4">
            <Users className="h-3 w-3 md:h-4 md:w-4 text-muted-foreground flex-shrink-0" />
            <span className="text-xs md:text-sm truncate">{parties.join(", ")}</span>
          </div>
          ...
          <div className="flex items-start gap-2 text-xs md:text-sm">
            ...
            <div>
              <p>{lastUpdate}</p>
              <p className="text-muted-foreground text-[10px] md:text-xs">{lastUpdateTime}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-50 p-4 md:p-6 border-t md:border-t-0 md:border-l flex flex-col justify-between">
          ...
          <Button className="mt-3 md:mt-4 w-full text-xs md:text-sm">Manage Transaction</Button>
        </div>
      </div>
    </Card>
  )
